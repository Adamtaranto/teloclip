...
synthetic contigs generated by scripts/testdata/generate_data.py. The alignments simulate
...
def get_contig_lengths() -> Dict[str, int]:
    """Return the lengths of synthetic contigs (must match scripts/testdata/generate_data.py)."""
    return {
...
def write_sam_file(
    ...
    with open(output_path, 'w') as f:
        ...
        f.write(
            '@PG\tID:generate_alignments\tVN:1.0\tCL:scripts/testdata/generate_alignments.py\n'
        )
